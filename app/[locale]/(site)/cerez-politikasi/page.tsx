    ...
    <>
      <section className="py-16 lg:py-24 bg-[#1c1c1c]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl md:text-5xl font-serif text-white">{t("cerez")}</h1>
        </div>
      </section>

      <section className="py-16 lg:py-24 bg-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          {legalContent.cookiePolicy && legalContent.cookiePolicy.length > 0 ? (
            <LegalContent content={legalContent.cookiePolicy} />
          ) : (
